...
| [Common](common/) | Shared mode validation, memory ownership, and end-to-end timing boundaries |
...
| Model aligned AU/frame pools, the single compressed gather, exact-pointer presentation, and fence-safe reuse | [`common/memory_pipeline.cpp`](common/memory_pipeline.cpp) |
